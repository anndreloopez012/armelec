...
if (isset($_GET["validacionesContacto"]) && !empty($_GET["validacionesContacto"])) {
    ...
    if ($strTipoValidacionContacto == "insert_form_contacto") {
        ...
        $ctg_nombre_completo = isset($_POST["ctg_nombre_completo"]) ? $_POST["ctg_nombre_completo"]  : '';
        ...
        $var_consulta = "INSERT INTO ctg_contacto(ctg_nombre_completo,ctg_telefono,ctg_correo,ctg_mensaje,img,ctg_modulo) VALUES ('$ctg_nombre_completo',$ctg_telefono,'$ctg_correo','$ctg_mensaje','$img','ini')";
        $val = 1;
        ...
        if ($val) {
            ...
            $mailContent = '<b>VisualMed - Contacto VISUALMED.online</b><br><br>
                ...
                <tr border="1">
                <td align="center"><b> NOMBRE: ' . $ctg_nombre_completo . '</b></td><br>
                </tr>
                </table><br><br>
