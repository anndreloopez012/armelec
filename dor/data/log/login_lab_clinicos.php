        ...
        if ($variableCode) {
            if (isset($_POST['username'])) {
                ...
                if ($rows == 1) {
                    ...
                    header('Location:../../app/laboratory/index.php');
                } else {
                    ...
                    if ($contador >= 5) {
                        ...
                        header('Location:login_lab_clinicos.php?error=2');
                    } else {
                        ...
                        if ($validar) {
                            ...
                            header('Location:login_lab_clinicos.php?error=1');
                        }
                    }
                }
            }
        } else {
            header('Location:login_lab_clinicos.php?error=4');
        }
    }
}
?>
<div style="text-align:center;">
    <h2>LABORATORIOS CLINICOS</h2>
</div>
<form action="" method="post" name="login">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <span> Intentos realizados = <?php echo $_SESSION['intentos'] ?></span> </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        </div>
                    </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <span>Su cuenta esta deshabilitada!</span><br> </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        </div>
                    </div>
    ...
    if (isset($_SESSION['usuario']) && $_SESSION['usuario'] != '') {
        ...
        <div id="register-link" class="text-right">
            <a href="resc_pass.php?us=cli" class="text-info">Olvidaste tu Contraseña?</a>
        </div><br>
        ...
        <div id="register-link" class="text-right">
            <?php
            if ($RegCli == 1) { ?>
                <a href="register_lab_clinicos.php" class="text-info">Crear usuario nuevo!</a>
            <?php
            } ?>
        </div><br>
        <div style="font-size:15px; text-align: center;color: #9B9B9B;">
        Sé parte de los Laboratorios clínicos recomendados para nuestros Pacientes. Si deseas formar parte de Visualmed escríbenos a <a href="mailto:gut.contacto@visualmed.online" title="Abre el administrador de correo electronico haciendo clic aqui">gut.contacto@visualmed.online</a> 
        </div>        
</form>
<?php
