        ...
        if ($variableCode) {
            if (isset($_POST['username'])) {
                ...
                if ($rows == 1) {
                    ...
                    header('Location:../../app/hospital/index.php');
                } else {
                    ...
                    if ($contador >= 5) {
                        ...
                        header('Location:login_hospitales.php?error=2');
                    } else {
                        ...
                        if ($validar) {
                            ...
                            header('Location:login_hospitales.php?error=1');
                        }
                    }
                }
            }
        } else {
            header('Location:login_hospitales.php?error=4');
        }
    }
}
?>
...
<form action="" method="post" name="login">
    ...
    if (isset($_SESSION['usuario']) && $_SESSION['usuario'] != '') {
        ...
        <div id="register-link" class="text-right">
            <a href="resc_pass.php?us=hos" class="text-info">Olvidaste tu Contraseña?</a>
        </div><br>
        ...
        <div id="register-link" class="text-right">
            ...
            if ($RegHos == 1) { ?>
                <a href="register_hospitales.php" class="text-info">Crear usuario nuevo!</a>
            <?php
            } ?>
        </div><br>
        <div style="font-size:15px; text-align: center;color: #9B9B9B;">
        Sé parte de los Hospitales recomendados para nuestros Pacientes. Si deseas formar parte de Visualmed escríbenos a <a href="mailto:gut.contacto@visualmed.online" title="Abre el administrador de correo electronico haciendo clic aqui">gut.contacto@visualmed.online</a> 
        </div>        
</form>
<?php
