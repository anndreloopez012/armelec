...
if ($variableUsr >= 1) {
    ...
    if (isset($_POST['username'])) {
        ...
        if ($variableCode) {
            if (isset($_POST['username'])) {
                ...
                if ($rows == 1) {
                    while ($rTMP = pg_fetch_assoc($result)) {
                        ...
                        $_SESSION['sucursal'] = $rTMP['sucursal'];
                    ...
                    header('Location:../../app/pharmacists/index.php');
                } else {
                    ...
                    if ($contador >= 5) {
                        ...
                        header('Location:login_farmacias.php?error=2');
                    } else {
            ...
            header('Location:login_farmacias.php?error=4');
        }
    }
}
?>
...
<form action="" method="post" name="login">
    ...
    if (isset($_SESSION['usuario']) && $_SESSION['usuario'] != '') {
        ...
        <div id="register-link" class="text-right">
            <a href="resc_pass.php?us=far" class="text-info">Olvidaste tu Contraseña?</a>
        </div><br>
        ...
        <div id="register-link" class="text-right">
            <?php
            if ($RegFar == 1) { ?>
                <a href="register_farmacias.php" class="text-info">Crear usuario nuevo!</a>
            <?php
            } ?>
        </div><br>
        <div style="font-size:15px; text-align: center;color: #9B9B9B;">
        Sé parte de las Farmacias recomendadas para nuestros Pacientes. Si deseas formar parte de Visualmed escríbenos a <a href="mailto:gut.contacto@visualmed.online" title="Abre el administrador de correo electronico haciendo clic aqui">gut.contacto@visualmed.online</a> 
        </div>        
</form>
<?php
