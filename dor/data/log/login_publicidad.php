        ...
        if ($variableCode) {
            if (isset($_POST['username'])) {
                ...
                if ($rows == 1) {
                    ...
                    header('Location:../../app/advertising/index.php');
                } else {
                    ...
                    if ($contador >= 5) {
                        ...
                        header('Location:login_publicidad.php?error=2');
                    } else {
                        ...
                        if ($validar) {
                            ...
                            header('Location:login_publicidad.php?error=1');
                        }
                    }
                }
            }
        } else {
            header('Location:login_publicidad.php?error=4');
        }
    }
}
?>
...
<form action="" method="post" name="login">
    ...
    if (isset($_SESSION['usuario']) && $_SESSION['usuario'] != '') {
        ...
        <div id="register-link" class="text-right">
            <a href="resc_pass.php?us=pub" class="text-info">Olvidaste tu Contraseña?</a>
        </div><br>
        ...
        <div id="register-link" class="text-right">
            <?php
            if ($RegPub == 1) { ?>
                <a href="register_publicidad.php" class="text-info">Crear usuario nuevo!</a>
            <?php
            } ?>
        </div><br>
        <div style="font-size:15px; text-align: center;color: #9B9B9B;">
        ¿Deseas promocionar tus productos o servicios en nuestra página? Contáctanos a <a href="mailto:gut.contacto@visualmed.online" title="Abre el administrador de correo electronico haciendo clic aqui">gut.contacto@visualmed.online</a> 
        </div>
</form>
<?php
