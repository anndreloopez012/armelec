        ...
        if ($variableCode) {
            if (isset($_POST['username'])) {
                ...
                if ($rows == 1) {
                    ...
                    header('Location:../../app/doctors/index.php');
                } else {
                    ...
                    if ($contador >= 5) {
                        ...
                        header('Location:login_doctor.php?error=2');
                    } else {
                        ...
                        if ($validar) {
                            ...
                            header('Location:login_doctor.php?error=1');
                        }
                    }
                }
            }
        } else {
            header('Location:login_doctor.php?error=4');
        }
    }
}
?>
...
<form action="" method="post" name="login">
    ...
    if (isset($_SESSION['usuario']) && $_SESSION['usuario'] != '') {
        ...
        <div id="register-link" class="text-right">
            <a href="resc_pass.php?us=med" class="text-info">Olvidaste tu Contraseña?</a>
        </div><br>
        ...
        <div id="register-link" class="text-right">
            <?php
            if ($RegMed == 1) { ?>
                <a href="register_doctor.php" class="text-info">Crear usuario nuevo!</a>
            <?php
            } ?>
        </div><br>
        <div style="font-size:15px; text-align: center;color: #9B9B9B;">
        Somos el mejor aliado entre Paciente y Médico para brindar un consolidado de la información que necesitas. Si deseas formar parte de Visualmed escríbenos a <a href="mailto:gut.contacto@visualmed.online" title="Abre el administrador de correo electronico haciendo clic aqui">gut.contacto@visualmed.online</a> 
        </div>
        <?php
        ?>
