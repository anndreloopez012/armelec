<script>
    function fntUpdate() {
        ...
        alertify.confirm('Tus Dietas', 'Seguro que desea continuar? ', function() {
            ...
            var objurl = document.getElementById("id_url");
            var urlId = objurl.value * 1;
            //alert(datos);
            //return false;
            ...
            $.ajax({
                ...
                data: datos,
                dataType: 'json',
                url: "doctorsPerfilClinical.php?ajax=true&validaciones=update&urlId=" + urlId,
                success: function(r) {
                    if (r.status) {
                        if (r.status == 1) {
    ...
    function fntValidacioncodigo() {
        ...
        if (!isNaN(intnombre) && (intcnombre > 0)) {
            ...
            $.ajax({
                ...
                url: "doctorsPerfilClinical.php?validaciones=validacion_nombre&nombre=" + intnombre,
                async: true,
                global: false,
    ...
    function fntDibujoTipSangre() {
        ...
        $.ajax({
            ...
            url: "doctorsPerfilClinical.php?validaciones=dibujo_tip_sangre",
            data: {},
            async: true,
            global: false,
            type: "post",
