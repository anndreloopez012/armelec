<script>
        ...
        alertify.confirm('Tus Medicamentos', 'Seguro que desea continuar? ', function() {
            ...
            if (!isNaN(intCode) && (intCode > 0)) {
                ...
                $.ajax({
                    ...
                    data: datos,
                    dataType: 'json',
                    url: "patientCurrentlySupplied.php?ajax=true&validaciones=update&code=" + intCode,
                    success: function(r) {
                        if (r.status) {
                            if (r.status == 1) {
                                //$('#formData')[0].reset();
    ...
    function fntDibujoTabla1() {
        ...
        $.ajax({
            ...
            url: "patientCurrentlySupplied.php?validaciones=busqueda_table1",
            data: {
                Search: strSearch,
            },
            async: true,
    ...
    function fntDibujoTabla2() {
        ...
        $.ajax({
            ...
            url: "patientCurrentlySupplied.php?validaciones=busqueda_table2",
            data: {
                Search: strSearch,
            },
            async: true,
    ...
    function fntDibujoTabla3() {
        ...
        $.ajax({
            ...
            url: "patientCurrentlySupplied.php?validaciones=busqueda_table3",
            data: {
                Search: strSearch,
            },
            async: true,
    ...
    function fntDibujoTabla4() {
        ...
        $.ajax({
            ...
            url: "patientCurrentlySupplied.php?validaciones=busqueda_table4",
            data: {
                Search: strSearch,
            },
            async: true,
    ...
    function fntDibujoTabla5() {
        ...
        $.ajax({
            ...
            url: "patientCurrentlySupplied.php?validaciones=busqueda_table5",
            data: {
                Search: strSearch,
            },
            async: true,
    ...
    function fntDibujoTabla6() {
        ...
        $.ajax({
            ...
            url: "patientCurrentlySupplied.php?validaciones=busqueda_table6",
            data: {
                Search: strSearch,
            },
            async: true,
    ...
    function fntDibujoTabla7() {
        ...
        $.ajax({
            ...
            url: "patientCurrentlySupplied.php?validaciones=busqueda_table7",
            data: {
                Search: strSearch,
            },
            async: true,
    ...
    function fntDibujoTabla8() {
        ...
        $.ajax({
            ...
            url: "patientCurrentlySupplied.php?validaciones=busqueda_table8",
            data: {
                Search: strSearch,
            },
            async: true,
    ...
    function fntDibujoTabla9() {
        ...
        $.ajax({
            ...
            url: "patientCurrentlySupplied.php?validaciones=busqueda_table9",
            data: {
                Search: strSearch,
            },
            async: true,
