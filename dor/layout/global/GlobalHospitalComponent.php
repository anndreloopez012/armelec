    ...
    <p>
      <p>
        ...
        <a class="btn btn-raised btn-info" href="../../app/doctors/index.php" role="button" aria-expanded="false" href="index.php">Menu</a>
          <a class="btn btn-raised btn-info btn-center" onclick="fntHospital()"><i class="fad fa-2x fa-hospital" style="color: black;"></i>Orden de Servicios Hospitalarios <b></b></a>
        </p>
        <div>
          <?php
          //HOSPITALES
