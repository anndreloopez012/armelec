<body>
                                ...
                                <form id="formData" method="POST">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            ?>
                                            <select class="form-control" id="ctg_pac_medica_freq1" name="ctg_pac_medica_freq1"  value="<?php echo  $ctg_pac_medica_freq1; ?>">
                                        ...
                                        <div class="form-group col-md-1 borrar"><br></br>
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            ?>
                                            <select class="form-control" id="ctg_pac_medica_freq3" name="ctg_pac_medica_freq3" value="<?php echo  $ctg_pac_medica_freq3; ?>">
                                                <option value="0">Seleccionar</option>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-sm-12 row">
                        <div class="col-sm-6">
                            <input class="form-control" name="Search1" id="Search1" type="text" style="text-transform:uppercase;" placeholder="Escribe el dato a buscar">
                        </div>
                        <div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-sm-12 row">
                        <div class="col-sm-6">
                            <input class="form-control" name="Search2" id="Search2" type="text" style="text-transform:uppercase;" placeholder="Escribe el dato a buscar">
                        </div>
                        <div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-sm-12 row">
                        <div class="col-sm-6">
                            <input class="form-control" name="Search3" id="Search3" type="text" style="text-transform:uppercase;" placeholder="Escribe el dato a buscar">
                        </div>
                        <div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-sm-12 row">
                        <div class="col-sm-6">
                            <input class="form-control" name="Search4" id="Search4" type="text" style="text-transform:uppercase;" placeholder="Escribe el dato a buscar">
                        </div>
                        <div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-sm-12 row">
                        <div class="col-sm-6">
                            <input class="form-control" name="Search5" id="Search5" type="text" style="text-transform:uppercase;" placeholder="Escribe el dato a buscar">
                        </div>
                        <div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-sm-12 row">
                        <div class="col-sm-6">
                            <input class="form-control" name="Search6" id="Search6" type="text" style="text-transform:uppercase;" placeholder="Escribe el dato a buscar">
                        </div>
                        <div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-sm-12 row">
                        <div class="col-sm-6">
                            <input class="form-control" name="Search7" id="Search7" type="text" style="text-transform:uppercase;" placeholder="Escribe el dato a buscar">
                        </div>
                        <div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-sm-12 row">
                        <div class="col-sm-6">
                            <input class="form-control" name="Search8" id="Search8" type="text" style="text-transform:uppercase;" placeholder="Escribe el dato a buscar">
                        </div>
                        <div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-sm-12 row">
                        <div class="col-sm-6">
                            <input class="form-control" name="Search9" id="Search9" type="text" style="text-transform:uppercase;" placeholder="Escribe el dato a buscar">
                        </div>
                        <div>
    ...
    <script>
        ...
        function fntDeleteRow_1() {
            document.getElementById("ctg_pac_medica_espe1").value = "";
            document.getElementById("ctg_pac_medica_cron1").value = "";
            document.getElementById("ctg_pac_medica_freq1").value = "";
            document.getElementById("ctg_pac_medica_date1").value = "";
            document.getElementById("ctg_pac_medica_code1").value = "";
            document.getElementById("ctg_pac_medica_code1").value = "";
        }

        function fntDeleteRow_2() {
            document.getElementById("ctg_pac_medica_espe2").value = "";
            document.getElementById("ctg_pac_medica_cron2").value = "";
            document.getElementById("ctg_pac_medica_freq2").value = "";
            document.getElementById("ctg_pac_medica_date2").value = "";
            document.getElementById("ctg_pac_medica_code2").value = "";
            document.getElementById("ctg_pac_medica_code2").value = "";
        }

        function fntDeleteRow_3() {
            document.getElementById("ctg_pac_medica_espe3").value = "";
            document.getElementById("ctg_pac_medica_cron3").value = "";
            document.getElementById("ctg_pac_medica_freq3").value = "";
            document.getElementById("ctg_pac_medica_date3").value = "";
            document.getElementById("ctg_pac_medica_code3").value = "";
            document.getElementById("ctg_pac_medica_code3").value = "";
        }

        function fntDeleteRow_4() {
            document.getElementById("ctg_pac_medica_espe4").value = "";
            document.getElementById("ctg_pac_medica_cron4").value = "";
            document.getElementById("ctg_pac_medica_freq4").value = "";
            document.getElementById("ctg_pac_medica_date4").value = "";
            document.getElementById("ctg_pac_medica_code4").value = "";
            document.getElementById("ctg_pac_medica_code4").value = "";
        }

        function fntDeleteRow_5() {
            document.getElementById("ctg_pac_medica_espe5").value = "";
            document.getElementById("ctg_pac_medica_cron5").value = "";
            document.getElementById("ctg_pac_medica_freq5").value = "";
            document.getElementById("ctg_pac_medica_date5").value = "";
            document.getElementById("ctg_pac_medica_code5").value = "";
            document.getElementById("ctg_pac_medica_code5").value = "";
        }

        function fntDeleteRow_6() {
            document.getElementById("ctg_pac_medica_espe6").value = "";
            document.getElementById("ctg_pac_medica_cron6").value = "";
            document.getElementById("ctg_pac_medica_freq6").value = "";
            document.getElementById("ctg_pac_medica_date6").value = "";
            document.getElementById("ctg_pac_medica_code6").value = "";
            document.getElementById("ctg_pac_medica_code6").value = "";
        }

        function fntDeleteRow_7() {
            document.getElementById("ctg_pac_medica_espe7").value = "";
            document.getElementById("ctg_pac_medica_cron7").value = "";
            document.getElementById("ctg_pac_medica_freq7").value = "";
            document.getElementById("ctg_pac_medica_date7").value = "";
            document.getElementById("ctg_pac_medica_code7").value = "";
            document.getElementById("ctg_pac_medica_code7").value = "";
        }

        function fntDeleteRow_8() {
            document.getElementById("ctg_pac_medica_espe8").value = "";
            document.getElementById("ctg_pac_medica_cron8").value = "";
            document.getElementById("ctg_pac_medica_freq8").value = "";
            document.getElementById("ctg_pac_medica_date8").value = "";
            document.getElementById("ctg_pac_medica_code8").value = "";
            document.getElementById("ctg_pac_medica_code8").value = "";
        }

        function fntDeleteRow_9() {
            document.getElementById("ctg_pac_medica_espe9").value = "";
            document.getElementById("ctg_pac_medica_cron9").value = "";
            document.getElementById("ctg_pac_medica_freq9").value = "";
            document.getElementById("ctg_pac_medica_date9").value = "";
            document.getElementById("ctg_pac_medica_code9").value = "";
            document.getElementById("ctg_pac_medica_code9").value = "";
        }
