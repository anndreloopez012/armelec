<section class="content col-md-12">
    ...
    <p>
        ...
        <a class="btn btn-raised btn-info" href="patientPerfilInfo.php" role="button" href="index.php">Regresar</a>
                                ...
                                <div class="card-body " style="display: block;">
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <?php $UsuarioId = $_SESSION['adm_usr_code']; ?>
                                            <input type="hidden" class="form-control" id="id_url" name="id_url" value="<?php echo  $UsuarioId; ?>">
