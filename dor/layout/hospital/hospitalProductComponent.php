                                ...
                                <form id="formData" method="POST">
                                    <div class="row">
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" class="form-control" id="ctg_hpp_code" name="ctg_hpp_code" onblur="fntValidacionCode()">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="exampleInputEmail1" class=" color-label">Nombre Del Producto</label>
                                            <input type="text" class="form-control" id="ctg_hpp_descrip" name="ctg_hpp_descrip">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="exampleInputEmail1" class=" color-label">Precio</label>
                                            <input type="text" class="form-control" id="ctg_hpp_pre" name="ctg_hpp_pre">
                                        </div>
    ...
    <script>
        ...
        function fntSelectSave(intParametro) {
            ...
            if (intParametro > 0) {
                ...
                var strhid_ctg_exa_code_ = $("#hid_ctg_ser_code_" + intParametro).val();
                var strhid_ctg_ser_pre_ = $("#hid_ctg_ser_pre_" + intParametro).val();
                var strhid_ctg_ser_imagen_ = $("#hid_ctg_ser_imagen_" + intParametro).val();
                var strhid_ctg_ser_descrip_ = $("#hid_ctg_ser_descrip_" + intParametro).val();

                //alert(strhid_ctg_exa_code_ + "                         strhid_ctg_exa_code_");
                //alert(strName + "                         strDPI");
                //alert(strDescrip + "                         strDPI");

                $("#ctg_pro_cod").val(strhid_ctg_exa_code_);
                $("#ctg_pro_desc").val(strhid_ctg_ser_descrip_);
                $("#ctg_pro_pre").val(strhid_ctg_ser_pre_);
                $("#ctg_pro_imagen").val(strhid_ctg_ser_imagen_);
            }
