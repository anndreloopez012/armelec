                            ...
                            <div class="col-md-12">
                                ...
                                <div class="container-fluid" style="min-height: 400px">
                                    <v-app id="inspire">
                                        <v-data-table
                                                :headers="headers"
                                                :items="arrayGlobalFarmac"
                                                sort-by="key_value"
                                                class="elevation-1"
                                                :search="search"
                                                item-key="ctg_far_nomcom"
...
<script>
    ...
    export default {
        ...
        methods:{
            farmacList(){
                var url = prefixUrl+'list-farmac';
                // this.alertMessagesLoadPage("Cargando la información de las farmacias", 2000);
                axios.get(url).then((response) => {
                    var res         = response.data.farmacList.data;
