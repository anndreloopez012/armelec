                            ...
                            <div class="col-md-12">
                                ...
                                <div class="container-fluid" style="min-height: 400px">
                                    <v-app id="inspire">
                                        <v-data-table
                                                :headers="headers"
                                                :items="arrayGlobalLaboratory"
                                                sort-by="key_value"
                                                class="elevation-1"
                                                :search="search"
                                                item-key="ctg_lab_nomcom"
...
<script>
    ...
    export default {
        ...
        methods:{
            laboratoryList(){
                var url = prefixUrl+'list-laboratory';
                // this.alertMessagesLoadPage("Cargando la información del laboratorio", 2000);
                axios.get(url).then((response) => {
                    var res         = response.data.laboratoryList.data;
                    ...
                    if(resCode == 200){
                        ...
                        this.arrayGlobalLaboratory = res;
