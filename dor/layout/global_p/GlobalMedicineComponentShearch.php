    ...
    <p>
      <p>
        ...
        <a class="btn btn-raised btn-info" href="../../app/patient/index.php" role="button" aria-expanded="false" href="index.php">Menu</a>
          <a class="btn btn-raised btn-info btn-center" onclick="fntMedicament()"><i class="fad fa-2x fa-tablets" style="color: black;"></i>Seleccion de Medicamentos <b><span style="color:black"> (<?php echo(empty($_SESSION['CARRITOMED']))? 0: count($_SESSION['CARRITOMED']); ?>) </span></b></a>
        </p>
        <div>
          <?php
