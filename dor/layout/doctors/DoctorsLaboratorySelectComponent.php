    ...
    <div class="col-md-12">
      <p>
        <p>
          ...
          <a class="btn btn-raised btn-info btn-center" type="button" data-toggle="collapse" data-target="#farmac" aria-expanded="false" aria-controls="farmac">LABORATORIOS</a>
          <?php if ($mensaje != "") { ?>
            <?PHP echo $mensaje; ?>
        ...
        <?php if (!empty($_SESSION['CARRITO'])) { ?>
          ...
          <div class="col-md-12">
            <div class="collapse show" id="farmac">
              <div class="card card-body">
                <div class="card card-primary collapsed-card">
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <table id="tableLab" class="table table-bordered table-striped table-hover table-sm">
            <thead>
              <tr class="table-info">
                <th>Codigo</th>
            ...
            <tbody>
              <?php
              if (is_array($arrTableCli) && (count($arrTableCli) > 0)) {
                reset($arrTableCli);
                foreach ($arrTableCli as $rTMP['key'] => $rTMP['value']) {
              ?>
                  <tr>
                    <td><?php echo  $rTMP["value"]['ctg_lce_code']; ?></td>
                    <td><?php echo  $rTMP["value"]['ctg_lce_descrip']; ?></td>
                    <td></td>
                  </tr>
              <?PHP
                }
