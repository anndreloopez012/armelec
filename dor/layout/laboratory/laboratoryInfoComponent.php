                                    ...
                                    <div id="divData">
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="ctg_lab_nomcom_" id="ctg_lab_nomcom_" value="<?php echo  $ctg_lab_nomcom; ?>">
                                                <input type="hidden" class="form-control" name="ctg_lab_nomcom" id="ctg_lab_nomcom" value="<?php echo  $ctg_lab_nomcom; ?>">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="ctg_lab_nit_" id="ctg_lab_nit_" value="<?php echo  $ctg_lab_nit; ?>">
                                                <input type="hidden" class="form-control" name="ctg_lab_nit" id="ctg_lab_nit" value="<?php echo  $ctg_lab_nit; ?>">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="exampleInputEmail1" class="bmd-label-floating color-label">Nombre de Sucursal </label>
                                                <input type="text" class="form-control" name="ctg_lab_suc_" id="ctg_lab_suc_" value="<?php echo  $ctg_lab_suc; ?>">
                                                <input type="hidden" class="form-control" name="ctg_lab_suc" id="ctg_lab_suc" value="<?php echo  $ctg_lab_suc; ?>">
                                            </div>
                                            <div class="form-group col-md-2 bmd-form-group is-focused">
                                                <label for="exampleInputEmail1" class="bmd-label-floating color-label">Horario de atencion al publico am</label>
                                                <input type="time" class="form-control" name="ctg_lab_hortda1" id="ctg_lab_hortda1" value="<?php echo  $ctg_lab_hortda1; ?>">
                                                <input type="time" class="form-control" name="ctg_lab_hortda2" id="ctg_lab_hortda2" value="<?php echo  $ctg_lab_hortda2; ?>">
                                            </div>

                                            <div class="form-group col-md-4">
                                                <label for="exampleTextarea" class="bmd-label-floating color-label">Direccion</label>
                                                <textarea class="form-control" name="ctg_lab_dir" id="ctg_lab_dir" rows="3"><?php echo  $ctg_lab_dir; ?></textarea>
                                            ...
                                            <div class="form-group col-md-1">
                                                ...
                                                <input type="text" class="form-control" name="ctg_lab_zona" id="ctg_lab_zona" value="<?php echo  $ctg_lab_zona; ?>">
                                            </div>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="hidden" id="hid_region" name="hid_region" value="<?php echo  $ctg_lab_dep; ?>">
                                            </div>
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="hidden" id="hid_distrito" name="hid_distrito" value="<?php echo  $ctg_lab_mun; ?>">
                                            </div>

                                            <div class="form-group col-md-2">
                                                <label for="exampleTextarea" class="bmd-label-floating color-label">Telefono</label>
                                                <input type="text" class="form-control" name="ctg_lab_tels" id="ctg_lab_tels" value="<?php echo  $ctg_lab_tels; ?>">
                                            </div>
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" class="form-control" name="ctg_lab_enc_dpi" id="ctg_lab_enc_dpi" value="<?php echo  $ctg_lab_enc_dpi; ?>">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="exampleTextarea" class="bmd-label-floating color-label">Nombre Completo</label>
                                                <input type="text" class="form-control" name="ctg_lab_enc_nom1" id="ctg_lab_enc_nom1" value="<?php echo  $ctg_lab_enc_nom1; ?>">
                                            </div>
                                                ...
                                                <select class="form-control" name="sexo_" id="sexo_">
                                                    ...
                                                    if (is_array($arrSexos) && (count($arrSexos) > 0)) {
                                                        ...
                                                        foreach ($arrSexos as $rTMP['key'] => $rTMP['value']) {
                                                            $strSelected = ($ctg_lab_enc_sexo == $rTMP["value"]['ctg_sex_cod']) ? "selected='selected'" : '';
                                                    ?>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <div class="card-body">
                                                            <div class="row " id="form-perfil">
                                                                <img src="<?php echo  $ctg_lab_pict; ?>" id="img_path" class="img-responsive" alt="" name="img_path" style="height:auto;width:100%;" class="responsive">
                                                                <br><br>
...
<script>
    ...
    function fntSelectEdit() {
        ...
        document.getElementById("ctg_lab_nomcom_").disabled = true;
        document.getElementById("ctg_lab_nit_").disabled = true;
        document.getElementById("ctg_lab_suc_").disabled = true;
