<nav class="navbar navbar-expand-lg navbar-dark bg-info">
  <img src="lib/dist/img/Vmo_log_GUT.png" alt="logo" class="rounded mx-auto d-block" alt="Responsive image">
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    ...
    <ul class="nav justify-content-center">
      <b class="navbar-brand" href="#"></b>
    </ul>
    <ul class="navbar-nav ml-auto">
      <li class="nav-item d-none d-sm-inline-block">
        <a data-toggle="modal" data-target="#contactoModal" class="nav-link">Contacto</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Ayuda</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block active">
        <a href="#" class="nav-link" data-toggle="modal" data-target="#updatemodal">Ingresar</a>
      </li>
    </ul>
  </div>
</nav>
