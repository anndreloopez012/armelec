...
if (isset($_GET["validaciones"]) && !empty($_GET["validaciones"])) {
    ...
    $ctg_pub_usr = $_SESSION['adm_usr_code'];
    ...
    $ctg_pub_nombreFull = $nombre_comercial;
    $nit = 0;
    ...
    $ctg_pub_ven_dt_Y = $ctg_pub_ven_dt_Y;
    ...
    if ($strTipoValidacion == "proces") {
        ...
        $val = 2;
        $var_consulta = "INSERT INTO ctg_empresas_publicidad(ctg_pub_nomcom,ctg_pub_nit,ctg_pub_contrato,ctg_pub_code,ctg_pub_email,ctg_pub_username,ctg_pub_pass,ctg_pub_estatus,ctg_pub_sol_dt,ctg_pub_aut_dt,ctg_pub_ven_dt,ctg_pub_sta,ctg_pub_dt,ctg_pub_usr) VALUES('$nombre_comercial','$nit','$contrato','$variableCode','$email','$nombre_usuario','" . md5($clave2) . "','$ctg_pub_estatus','$ctg_pub_sol_dt','$ctg_pub_aut_dt','$ctg_pub_ven_dt','$ctg_pub_sta','$ctg_pub_dt','$ctg_pub_usr');";
        ...
        $val = 3;
        $var_consulta = "INSERT INTO web_users(mail,username,adm_usr_tipo,adm_usr_code,password,nombre_completo,adm_usr_contrato,status_actual,adm_date_ven) VALUES ('$email','$nombre_usuario','$adm_usr_tipo','$usuarioCode','" . md5($clave2) . "','$ctg_pub_nombreFull','$contrato',$ctg_pub_estatus,'$ctg_pub_ven_dt');";
        if (pg_query($rmfAdm, $var_consulta)) {
            $arrInfo['status'] = $val;
        } else {
            $arrInfo['status'] = 0;
