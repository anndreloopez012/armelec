<?php
    ...
    require_once '../../api/sistema/adm_usr_perfil_labCli.php';

    require_once '../dependenciasHead.php';
    
    require_once '../../api/admMenu.php';

    require_once '../../api/sistema/adm_usr_perfil_labCliAJAX.php';

    require_once '../../layout/nav.php';

    //require_once '../../layout/menu.php';

    require_once '../../layout/sistema/usr_perfil_labCliComponent.php';
