    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">INFORMACION DE LA SOLICITUD</h5>
            ...
            <div class="modal-body">
                <form id="formData" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="pago_forma" name="pago_forma">
                    </div>

                    <div class="form-group">
                        <label>Transaccion numero</label>
                        <input type="text" class="form-control" id="pago_numero" name="pago_numero">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" class="form-control" id="clave2" name="clave2">
                    </div>
                </form>
            </div>
...
<script>
    ...
    function fntView(intParametro) {
        ...
        if (intParametro > 0) {
            ...
            var str_clave2 = $("#hid_clave2" + intParametro).val();
            var str_pago_forma = $("#hid_pago_forma" + intParametro).val();
            var str_pago_numero = $("#hid_pago_numero" + intParametro).val();

            //alert(str_clave2 + "                         str_clave2");
            ...
            $("#pago_forma").val(str_pago_forma);
            $("#pago_numero").val(str_pago_numero);
        }
