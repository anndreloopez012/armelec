            ...
            <div class="modal-body">
                <form id="formData" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="forma_numero" name="forma_numero">
                    </div>
...
<script>
    ...
    function fntView(intParametro) {
        ...
        if (intParametro > 0) {
            ...
            var str_forma_pago = $("#hid_pago_forma" + intParametro).val();
            var str_forma_numero = $("#hid_pago_numero" + intParametro).val();
            ...
            $("#forma_pago").val(str_forma_pago);
            $("#forma_numero").val(str_forma_numero);
    ...
    function fntSelect(intParametro) {
        ...
        if (intParametro > 0) {
            ...
            var str_clave1 = $("#hid_clave1" + intParametro).val();
            var str_clave2 = $("#hid_clave2" + intParametro).val();
            var str_forma_pago = $("#hid_forma_pago" + intParametro).val();
            var str_forma_numero = $("#hid_forma_numero" + intParametro).val();
