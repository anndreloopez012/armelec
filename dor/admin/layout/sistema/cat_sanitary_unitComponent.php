            ...
            <div class="row">
                ...
                <div class="cont col-lg-6">
                    <form id="formData" method="POST"><br>
                        <div class="row">
                            <div class="col-4">
                                <input type="text" id="ctg_uns_cod" name="ctg_uns_cod" class="form-control" placeholder="Codigo" onblur="fntValCodigo()">
                            </div>
                            <div class="col-8">
                                <input type="text" id="ctg_uns_desc" name="ctg_uns_desc" class="form-control" placeholder="Descripcion">
                            </div>
                            <div class="col-12"><br>
...
<script>
    ...
    function fntSelectEdit(intParametro) {
        ...
        if (intParametro > 0) {
            ...
            var strctg_uns_cod = $("#hid_ctg_uns_cod" + intParametro).val();
            var strctg_uns_desc = $("#hid_ctg_uns_desc" + intParametro).val();
         
            //alert(strCodigo + "                         strCodigo");

            $("#ctg_uns_cod").val(strctg_uns_cod);
            $("#ctg_uns_desc").val(strctg_uns_desc);
        }
