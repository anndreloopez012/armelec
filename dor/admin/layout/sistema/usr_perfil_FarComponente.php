                    ...
                    <form id="formData" method="POST">
                        <div class="form-group row">
                            ...
                            <div class=" col-md-4">
                                ...
                                <input type="number" class="form-control" name="ctg_fac_contrato" id="ctg_fac_contrato" onfocus="fntModalContrato()">
                            </div>
                            <div class="col-lg-2"></div>

                            <label for="" class="col-form-label col-sm-4 ">Nombre Comercial</label>
                            <div class=" col-md-4">
                                <input type="text" class="form-control" name="ctg_fac_nom" id="ctg_fac_nom">
                            </div>
                            <div class="col-lg-2"></div>

                            <label for="" class="col-form-label col-sm-4 ">Razon Social</label>
                            <div class=" col-md-4">
                                <input type="text" class="form-control" name="ctg_fac_razsoc" id="ctg_fac_razsoc" onblur="fntValEmpresa()">
                            </div>
                            <div class="col-lg-2"></div>

                            <label for="" class="col-form-label col-sm-4 ">Numero de Nit </label>
                            <div class=" col-md-4">
                                <input type="text" class="form-control" name="ctg_fac_nit" id="ctg_fac_nit">
                            </div>
                            <div class="col-lg-2"></div>

                            <label for="" class="col-form-label col-sm-4 ">Dirección</label>
                            <div class=" col-md-4">
                                <textarea class="form-control" name="ctg_fac_dir" id="ctg_fac_dir" rows="3"></textarea>
                            ...
                            <div class=" col-md-1">
                                <input type="text" class="form-control" name="ctg_fac_zona" id="ctg_fac_zona">
                            </div>
                            ...
                            <div class=" col-md-2">
                                <input type="text" class="form-control" name="ctg_fac_tels" id="ctg_fac_tels">
                            </div>
                            <div class="col-lg-4"></div>
                            <label for="" class="col-form-label col-sm-4 ">Correo</label>
                            <div class=" col-md-4">
                                <input type="text" class="form-control" name="ctg_fac_email" id="ctg_fac_email" onblur="fntValMail()">
                            </div>
                            <div class="col-lg-2"></div>
                            ...
                            <div class=" col-md-4">
                                <input type="text" class="form-control" name="password" id="password" password>
                            </div>
                            <div class="col-lg-2"></div>
...
<script>
    ...
    function fntSelectContrato(intParametro) {
        ...
        if (intParametro > 0) {
            ...
            $("#ctg_fac_contrato").val(strhid_contrato);
            $("#ctg_fac_nom").val(strhid_nombre);
            $("#ctg_fac_razsoc").val(strhid_razon);
            $("#ctg_fac_nit").val(strhid_nit);
            $("#ctg_fac_dir").val(strhid_dir);
            $("#ctg_fac_zona").val(strhid_zona);
            $("#ctg_fac_tels").val(strhid_tels);
            //$("#").val(strhid_email);
