            ...
            <div class="row">
                ...
                <div class="cont col-lg-6">
                    <form id="formData" method="POST"><br>
                        <div class="row">
                            <div class="col-4">
                                <input type="text" id="ctg_civ_cod" name="ctg_civ_cod" class="form-control" placeholder="Codigo" onblur="fntValCodigo()">
                            </div>
                            <div class="col-8">
                                <input type="text" id="ctg_civ_desc" name="ctg_civ_desc" class="form-control" placeholder="Descripcion">
                            </div>
                            <div class="col-12"><br>
...
<script>
    ...
    function fntSelectEdit(intParametro) {
        ...
        if (intParametro > 0) {
            ...
            var strctg_civ_cod = $("#hid_ctg_civ_cod" + intParametro).val();
            var strctg_civ_desc = $("#hid_ctg_civ_desc" + intParametro).val();
         
            //alert(strCodigo + "                         strCodigo");

            $("#ctg_civ_cod").val(strctg_civ_cod);
            $("#ctg_civ_desc").val(strctg_civ_desc);
        }
