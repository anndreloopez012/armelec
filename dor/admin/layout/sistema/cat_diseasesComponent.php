            ...
            <div class="row">
                ...
                <div class="cont col-lg-6">
                    <form id="formData" method="POST"><br>
                        <div class="row">
                            <div class="col-4">
                                <input type="text" id="ctg_enf_cod" name="ctg_enf_cod" class="form-control" placeholder="Codigo" onblur="fntValCodigo()">
                            </div>
                            <div class="col-8">
                                <input type="text" id="ctg_enf_desc" name="ctg_enf_desc" class="form-control" placeholder="Descripcion">
                            </div>
                            <div class="col-12"><br>
...
<script>
    ...
    function fntSelectEdit(intParametro) {
        ...
        if (intParametro > 0) {
            ...
            var strctg_enf_cod = $("#hid_ctg_enf_cod" + intParametro).val();
            var strctg_enf_desc = $("#hid_ctg_enf_desc" + intParametro).val();
         
            //alert(strCodigo + "                         strCodigo");

            $("#ctg_enf_cod").val(strctg_enf_cod);
            $("#ctg_enf_desc").val(strctg_enf_desc);
        }
