                    ...
                    <form id="formData" method="POST">
                        <div class="form-group row">
                            ...
                            <div class=" col-md-4">
                                ...
                                <input type="number" class="form-control" name="ctg_laf_contrato" id="ctg_laf_contrato" onfocus="fntModalContrato()">
                            </div>
                            <div class="col-lg-2"></div>

                            <label for="" class="col-form-label col-sm-4 ">Nombre Comercial</label>
                            <div class=" col-md-4">
                                <input type="text" class="form-control" name="ctg_laf_nomcom" id="ctg_laf_nomcom" onblur="fntValEmpresa()">
                            </div>
                            <div class="col-lg-2"></div>

                            <label for="" class="col-form-label col-sm-4 ">Numero de Nit </label>
                            <div class=" col-md-4">
                                <input type="text" class="form-control" name="ctg_laf_nit" id="ctg_laf_nit">
                            </div>
                            <div class="col-lg-2"></div>

                            <label for="" class="col-form-label col-sm-4 ">Dirección</label>
                            <div class=" col-md-4">
                                <textarea class="form-control" name="ctg_laf_dir" id="ctg_laf_dir" rows="3"></textarea>
                            ...
                            <div class=" col-md-1">
                                <input type="text" class="form-control" name="ctg_laf_zona" id="ctg_laf_zona">
                            </div>
                            ...
                            <div class=" col-md-2">
                                <input type="text" class="form-control" name="ctg_laf_tels" id="ctg_laf_tels">
                            </div>
                            <div class="col-lg-6"></div>
                            <label for="" class="col-form-label col-sm-4 ">Correo</label>
                            <div class=" col-md-4">
                                <input type="text" class="form-control" name="ctg_laf_email" id="ctg_laf_email" onblur="fntValMail()">
                            </div>
                            <div class="col-lg-2"></div>
                            ...
                            <div class=" col-md-3">
                                <input type="text" class="form-control" name="ctg_laf_enc_dpi" id="ctg_laf_enc_dpi">
                            </div>
                            <div class="col-lg-2"></div>

                            <label for="" class="col-form-label col-sm-4 ">Nombre Completo</label>
                            <div class=" col-md-4">
                                <input type="text" class="form-control" name="ctg_laf_enc_nom" id="ctg_laf_enc_nom">
                            </div>
...
<script>
    ...
    function fntSelectContrato(intParametro) {
        ...
        if (intParametro > 0) {
            ...
            $("#ctg_laf_contrato").val(strhid_contrato);
            $("#ctg_laf_nomcom").val(strhid_nombre);
            $("#ctg_laf_nit").val(strhid_nit);
            $("#ctg_laf_dir").val(strhid_dir);
            $("#ctg_laf_zona").val(strhid_zona);
            $("#ctg_laf_tels").val(strhid_tels);
            //$("#").val(strhid_email);
