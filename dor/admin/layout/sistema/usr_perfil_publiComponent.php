                    ...
                    <form id="formData" method="POST">
                        <div class="form-group row">
                            ...
                            <div class=" col-md-4">
                                ...
                                <input type="text" class="form-control" name="ctg_pub_contrato" id="ctg_pub_contrato" onfocus="fntModalContrato()">
                            </div>
                            <div class="col-lg-2"></div>
                            ...
                            <div class=" col-md-4">
                                <input type="text" class="form-control" name="ctg_pub_razsoc" id="ctg_pub_razsoc">
                            </div>
                            <div class="col-lg-2"></div>
                            ...
                            <div class=" col-md-4">
                                <input type="text" class="form-control" name="ctg_pub_nomcom" id="ctg_pub_nomcom">
                            </div>
                            <div class="col-lg-2"></div>
                            ...
                            <div class=" col-md-4">
                                <input type="text" class="form-control" name="ctg_pub_nit" id="ctg_pub_nit">
                            </div>
                         
                            <div class="col-lg-2"></div>
                            <label for="" class="col-form-label col-sm-4 ">Dirección</label>
                            <div class=" col-md-4">
                                <textarea class="form-control" name="ctg_pub_dir" id="ctg_pub_dir" rows="3"></textarea>
                            ...
                            <div class=" col-md-1">
                                <input type="text" class="form-control" name="ctg_pub_zona" id="ctg_pub_zona">
                            </div>
                            ...
                            <div class=" col-md-2">
                                <input type="text" class="form-control" name="ctg_pub_telcel" id="ctg_pub_telcel">
                            </div>
                            <div class="col-lg-6"></div>

                            <label for="" class="col-form-label col-sm-4 ">Correo</label>
                            <div class=" col-md-4">
                                <input type="text" class="form-control" name="ctg_pub_email" id="ctg_pub_email" onblur="fntValMail()">
                            </div>
                            <div class="col-lg-2"></div>
    ...
    function fntModalContrato() {
     ...
     function fntSelectContrato(intParametro) {
        ...
        if (intParametro > 0) {
            ...
            $("#ctg_pub_contrato").val(strhid_contrato);
            $("#ctg_pub_razsoc").val(strhid_razsoc);
            $("#ctg_pub_nomcom").val(strhid_nombre);
            $("#ctg_pub_nit").val(strhid_nit);
            $("#ctg_pub_dir").val(strhid_dir);
            $("#ctg_pub_zona").val(strhid_zona);
            $("#ctg_pub_tels").val(strhid_tels);
            //$("#").val(strhid_email);
