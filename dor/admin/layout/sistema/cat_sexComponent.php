            ...
            <div class="row">
                ...
                <div class="cont col-lg-6">
                    <form id="formData" method="POST"><br>
                        <div class="row">
                            <div class="col-4">
                                <input type="text" id="ctg_sex_cod" name="ctg_sex_cod" class="form-control" placeholder="Codigo" onblur="fntValCodigo()">
                            </div>
                            <div class="col-8">
                                <input type="text" id="ctg_sex_desc" name="ctg_sex_desc" class="form-control" placeholder="Descripcion">
                            </div>
                            <div class="col-12"><br>
...
<script>
    ...
    function fntSelectEdit(intParametro) {
        ...
        if (intParametro > 0) {
            ...
            var strctg_sex_cod = $("#hid_ctg_sex_cod" + intParametro).val();
            var strctg_sex_desc = $("#hid_ctg_sex_desc" + intParametro).val();
         
            //alert(strCodigo + "                         strCodigo");

            $("#ctg_sex_cod").val(strctg_sex_cod);
            $("#ctg_sex_desc").val(strctg_sex_desc);
        }
