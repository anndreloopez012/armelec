            ...
            <div class="row">
                ...
                <div class="cont col-lg-6">
                    <form id="formData" method="POST"><br>
                        <div class="row">
                            <div class="col-4">
                                <input type="text" id="ctg_fab_id" name="ctg_fab_id" class="form-control" placeholder="Codigo" onblur="fntValCodigo()">
                            </div>
                            <div class="col-8">
                                <input type="text" id="ctg_fab_desc" name="ctg_fab_desc" class="form-control" placeholder="Descripcion">
                            </div>
                            <div class="col-12"><br>
...
<script>
    ...
    function fntSelectEdit(intParametro) {
        ...
        if (intParametro > 0) {
            ...
            var strctg_fab_id = $("#hid_ctg_fab_id" + intParametro).val();
            var strctg_fab_desc = $("#hid_ctg_fab_desc" + intParametro).val();
         
            //alert(strCodigo + "                         strCodigo");

            $("#ctg_fab_id").val(strctg_fab_id);
            $("#ctg_fab_desc").val(strctg_fab_desc);
        }
