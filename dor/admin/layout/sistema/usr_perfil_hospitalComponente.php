                    ...
                    <form id="formData" method="POST">
                        <div class="form-group row">
                            ...
                            <div class=" col-md-4">
                                ...
                                <input type="number" class="form-control" name="ctg_hos_contrato" id="ctg_hos_contrato" onfocus="fntModalContrato()">
                            </div>
                            <div class="col-lg-2"></div>

                            <label for="" class="col-form-label col-sm-4 ">Nombre Comercial</label>
                            <div class=" col-md-4">
                                <input type="text" class="form-control" name="ctg_hos_nomcom" id="ctg_hos_nomcom">
                            </div>
                            <div class="col-lg-2"></div>

                            <label for="" class="col-form-label col-sm-4 ">Numero de Nit </label>
                            <div class=" col-md-4">
                                <input type="text" class="form-control" name="ctg_hos_nit" id="ctg_hos_nit">
                            </div>
                            <div class="col-lg-2"></div>

                            <label for="" class="col-form-label col-sm-4 ">Dirección</label>
                            <div class=" col-md-4">
                                <textarea class="form-control" name="ctg_hos_dir" id="ctg_hos_dir" rows="3"></textarea>
                            ...
                            <div class=" col-md-1">
                                <input type="text" class="form-control" name="ctg_hos_zona" id="ctg_hos_zona">
                            </div>
                            ...
                            <div class=" col-md-2">
                                <input type="text" class="form-control" name="ctg_hos_tels" id="ctg_hos_tels">
                            </div>
                            <div class="col-lg-6"></div>
                            <label for="" class="col-form-label col-sm-4 ">Correo</label>
                            <div class=" col-md-4">
                                <input type="text" class="form-control" name="ctg_hos_email" id="ctg_hos_email" onblur="fntValMail()">
                            </div>
                            <div class="col-lg-2"></div>
                            ...
                            <div class=" col-md-3">
                                <input type="text" class="form-control" name="ctg_hos_enc_dpi" id="ctg_hos_enc_dpi">
                            </div>
                            <div class="col-lg-2"></div>

                            <label for="" class="col-form-label col-sm-4 ">Nombre Completo</label>
                            <div class=" col-md-4">
                                <input type="text" class="form-control" name="ctg_hos_enc_nom" id="ctg_hos_enc_nom">
                            </div>
                            <div class="col-lg-2"></div>
...
<script>
    ...
    function fntSelectContrato(intParametro) {
        ...
        if (intParametro > 0) {
            ...
            $("#ctg_hos_contrato").val(strhid_contrato);
            $("#ctg_hos_nomcom").val(strhid_nombre);
            $("#ctg_hos_razsoc").val(strhid_razon);
            $("#ctg_hos_nit").val(strhid_nit);
            $("#ctg_hos_dir").val(strhid_dir);
            $("#ctg_hos_zona").val(strhid_zona);
            $("#ctg_hos_tels").val(strhid_tels);
            //$("#").val(strhid_email);
