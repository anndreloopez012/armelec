            ...
            <div class="row">
                ...
                <div class="cont col-lg-6">
                    <form id="formData" method="POST"><br>
                        <div class="row">
                            <div class="col-4">
                                <input type="text" id="ctg_tps_id" name="ctg_tps_id" class="form-control" placeholder="Codigo" onblur="fntValCodigo()">
                            </div>
                            <div class="col-8">
                                <input type="text" id="ctg_tps_desc" name="ctg_tps_desc" class="form-control" placeholder="Descripcion">
                            </div>
                            <div class="col-12"><br>
...
<script>
    ...
    function fntSelectEdit(intParametro) {
        ...
        if (intParametro > 0) {
            ...
            var strctg_tps_id = $("#hid_ctg_tps_id" + intParametro).val();
            var strctg_tps_desc = $("#hid_ctg_tps_desc" + intParametro).val();
         
            //alert(strCodigo + "                         strCodigo");

            $("#ctg_tps_id").val(strctg_tps_id);
            $("#ctg_tps_desc").val(strctg_tps_desc);
        }
